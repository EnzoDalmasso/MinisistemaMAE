        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObraSocial = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Turnos_Disponibilidad",
                table: "Turnos",
                columns: new[] { "ProfesionalId", "Fecha", "Horario" },
                unique: true,
                filter: "\"Estado\" <> 'Cancelado'");

            migrationBuilder.CreateIndex(
                name: "IX_Turnos_Fecha",
                table: "Turnos",
                column: "Fecha");
